...
int dist = 0;
uint32_t TIM1_CH1_DC = 0;
uint32_t TIM1_CH2_DC = 0;
uint32_t TIM1_CH3_DC = 0;
uint32_t TIM8_CH3_DC = 0;
//uin32_t simple_speeds[11] = {0, 26, 52, 78, 104, 130, 156, 182, 208, 234, 260};
/* USER CODE END PV */
...
int main(void)
{
  ...
  while(TIM1_CH1_DC < 128){
	    TIM1->CCR1 = TIM1_CH1_DC;
	    TIM1->CCR2 = TIM1_CH2_DC;
	    TIM1->CCR3 = TIM1_CH3_DC;
	    TIM8->CCR3 = TIM8_CH3_DC;
	    TIM1_CH1_DC += 1;
	    TIM1_CH2_DC += 1;
	    TIM1_CH3_DC += 1;
	    TIM8_CH3_DC += 1;
...
{
    if (GPIO_Pin == GPIO_PIN_10)  // PA9 = ECHO
    {
